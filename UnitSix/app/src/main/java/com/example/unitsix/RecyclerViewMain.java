...
public class RecyclerViewMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle b) {
        ...
        String[] title = {"Title 1","Title 1", "Title 1", "Title 1","Title 1","Title 1", "Title 1", "Title 1"};

        String[] description = {"This is description 1.","This is description 1.","This is description 1.",
                "This is description 1.", "This is description 1.","This is description 1.",
                "This is description 1.","This is description 1."};
